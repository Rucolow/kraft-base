  ...
  return (
    <Screen>
      ...
      <button
        ...
        className="mb-1 flex min-h-[50px] w-full items-center justify-center gap-2 rounded-[13px] bg-orange font-bold text-[0.92rem] text-onaccent shadow-kb"
      >
      ...
      <div className="flex items-center gap-2">
        ...
        <button
          ...
          className="grid h-[42px] w-[42px] shrink-0 place-items-center rounded-[11px] bg-orange text-onaccent"
        >
          <Pin size={17} />
        </button>
      </div>
